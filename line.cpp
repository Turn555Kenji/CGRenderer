                ...
                double Xvpmin, double Yvpmin, double Xvpmax, double Yvpmax)
{
    ...
    if(perspectflag){
        ...
        p[3][0] = 0; p[3][1] = 0; p[3][2] = 1.0/dist; p[3][3] = 1;
        ...
        if (m1[3][0] != 0) {
            ...
            P1_proj[0][0] = m1[0][0] / m1[3][0];
            P1_proj[1][0] = m1[1][0] / m1[3][0];
            P1_proj[2][0] = m1[2][0] / m1[3][0];
        ...
        Matrix m2 = p * auxP2;
        if (m2[3][0] != 0) {
            P2_proj[0][0] = m2[0][0] / m2[3][0];
            P2_proj[1][0] = m2[1][0] / m2[3][0];
            P2_proj[2][0] = m2[2][0] / m2[3][0];
    ...
    bool visible = clipplingCohen(wx1, wy1, wx2, wy2, Xwmin, Ywmin, Xwmax, Ywmax);
    if (!visible) {
        return;
    }
    ...
    // Ponto 2: Mundo -> NDC -> Viewport (Usando P2_proj)
...
bool Line::clipplingCohen(double& x1, double& y1, double& x2, double& y2, double Xwmin, double Ywmin, double Xwmax, double Ywmax)
{
